<template>
  <main>
    ...
    <section v-if="expand.bar">
      <figure>
        <v-chart
          ...
          autoresize
          :loading="barLoading"
          :loading-options="barLoadingOptions"
      ...
      <p><button :disabled="seconds > 0" @click="refresh">Refresh</button></p>
    </section>
    ...
    <section v-if="expand.flight">
      <p>
        <small>You may use <code>manual-update</code> prop for performance critical
          use cases.</small>
      </p>
    ...
    <footer>
      ...
      >MIT License</a>|<a href="//github.com/ecomfe/vue-echarts">View on GitHub</a>
    </footer>
